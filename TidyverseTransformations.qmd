...
Задача сегодняшнего занятия будет заключаться в изучении функций, которые используются для трансформации данных - их чистки, фильтрации, вычислении новых переменных и описательных статистик.

В основном мы будем работать с одной из библиотек семейства `tidyverse` - `dplyr`

![](data:image/png;base64,),

Эта библиотека является одной из лучших для разнообразных трансформаций данных, потребность в которых возникает постоянно в процессе анализа.

## Фильтрация строк filter()

Рассмотрим основные функции библиотеки на примере набора данных `flights` из библиотеки -- `nycflights13`, в котором содержится информация о 336 776 полетах, совершенных из аэропорта Нью-Йорка в 2013 году. Данные предоставлены Бюро по статистике США, справку по ним можно найти по запросу `?flights`.
...
1.  Отберите полеты, прилет которых (arr_delay) задерживался на 2 или более часа.
2.  Вылетали в Хьюстон (IAH или HOU)
3.  Совершались в летние месяцы.
...
Например, отсортируем полеты по дате (сначала по году, потом по месяцу и дню):

```{r}
arrange(flights, year, month, day)
```

Если нам нужно отсортировать что-то по убыванию, то функция `desc()` поможет нам перегруппировать значения в столбце:

```{r}
arrange(flights, desc(dep_delay))
```

\*\* ! Пропущенные значения (NA) - всегда располагаются в конце списка, независимо от направления сортировки\*\*:
...
1.  Отсортируйте полеты, чтобы найти те, что имеют наибольшие значения задержки, независимо от того, что задержали - вылет или прилет. Найдите также полеты, которые вылетели раньше.
2.  Найдите самые короткие (быстрые) полеты.
...
```{r}
# Напишите Ваш код или комментарии здесь.
```
